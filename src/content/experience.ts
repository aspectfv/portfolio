...
export const experience: readonly ExperienceEntry[] = [
  {
    ...
    summary:
      'Backend engineer on a payments platform built as federated microservices. I own several of the platform’s core services and work across authentication, payment orchestration, and public API security. Day to day that means service boundaries, migrations, and making a system that moves money fail predictably.',
